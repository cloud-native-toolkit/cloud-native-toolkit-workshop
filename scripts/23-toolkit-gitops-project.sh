...
TOOLKIT_GITOPS_NAMESPACE=${TOOLKIT_GITOPS_NAMESPACE:-tools}
TOOLKIT_GITOPS_APP=${TOOLKIT_GITOPS_APP:-toolkit}
TOOLKIT_GITOPS_HOST=${TOOLKIT_GITOPS_HOST:-gitea.tools}
TOOLKIT_GITOPS_PORT=${TOOLKIT_GITOPS_PORT:-3000}
TOOLKIT_GITOPS_BRANCH=${TOOLKIT_GITOPS_BRANCH:-main}
